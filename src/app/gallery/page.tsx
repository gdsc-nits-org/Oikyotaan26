...
// --- Gallery Data Setup ---
const galleryData = [
  { topImg: "/photog/Frame1.png", bottomImg: "/photog/Frame1.png" },
  { topImg: "/photog/Frame1.png", bottomImg: "/photog/Frame1.png" },
  { topImg: "/photog/Frame1.png", bottomImg: "/photog/Frame1.png" },
  { topImg: "/photog/Frame1.png", bottomImg: "/photog/Frame1.png" },
  { topImg: "/photog/Frame1.png", bottomImg: "/photog/Frame1.png" },
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#7a2822] text-white font-sans overflow-hidden">
      ...
      <header className="relative mx-auto w-full max-w-7xl px-4 pt-12 pb-8 text-center flex flex-col items-center">
        <img src="/photog/image20.png" className="animate-float absolute left-2 sm:left-4 lg:left-8 top-10 sm:top-12 lg:top-16 w-16 sm:w-24 md:w-32 lg:w-34 h-auto object-contain" style={{ '--rotation': '-15deg' } as React.CSSProperties} />
        <img src="/photog/image25.png" className="animate-float absolute left-1 sm:left-12 lg:left-24 top-28 sm:top-36 md:top-44 lg:top-52 w-16 sm:w-24 md:w-32 lg:w-34 h-auto object-contain" style={{ '--rotation': '-5deg', animationDelay: '1s' } as React.CSSProperties} />
        <img src="/photog/image23.png" className="animate-float absolute right-4 sm:right-16 lg:right-28 top-20 sm:top-24 lg:top-30 w-16 sm:w-24 md:w-32 lg:w-34 h-auto object-contain" style={{ '--rotation': '15deg', animationDelay: '0.5s' } as React.CSSProperties} />
        <img src="/photog/image17.png" className="animate-float absolute right-2 sm:right-4 lg:right-8 top-48 sm:top-56 md:top-64 lg:top-72 w-16 sm:w-24 md:w-32 lg:w-34 h-auto object-contain" style={{ '--rotation': '5deg', animationDelay: '1.5s' } as React.CSSProperties} />
